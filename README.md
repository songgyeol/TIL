...
1. 앱출시(2개 목표)
2. 유명앱 클론(2개)
-클론시 웹에서 모바일버젼 확인 후 이미지 받기(팁)
-쇼핑몰,여행앱 유용함
-MVP 모든걸 만들 수 없음, 필수기능만 활용하기(최소의 시간으로 효과내기)

정보팁 - clien,wwdc 등 ios최신 업데이트(기능들) 확인하기
노션,깃 잘 정리하기

그 외) Links for ios develoer, Apple human interface guideline
